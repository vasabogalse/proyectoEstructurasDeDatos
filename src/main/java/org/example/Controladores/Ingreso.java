...
public class Ingreso {
    ...
    public void Ingresar(ActionEvent event) throws IOException {
        ...
        try {
            ...
            if (!objeto.matches()){
                novedad.setText("Dato inválido,por favor verifique la información.");
                return;
            }
        }

        if (((identificacion.getText().equals("12345678") || identificacion.getText().toLowerCase().equals("coordinador@gmail.com"))) && contrasena.getText().toLowerCase().equals("coordinador")) {
