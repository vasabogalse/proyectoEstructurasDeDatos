...
public class SistemaDeGestionClinica extends Application {
    ...
    public static void main(String[] args) {
        ...
        //Paciente.
        Paciente paciente1 = new Paciente("1000194793","Ximena","Castañeda Ochoa","Ximena@gmail.com","Cra. 45 #72-56",19,"05/10/2001","7865744","Carlos Lopez","2631551");
        Paciente paciente2 = new Paciente("1008194713","Felipe","Quintero Cano","Felipe@gmail.com","Cl. 78 #86-40",25,"14/03/1995","3193274553","Sofia Velez","4181376");
        Paciente paciente3 = new Paciente("1078694724","Juan Felipe","Rojas Calderon","Juan@gmail.com","Cra. 77A #50-30",25,"05/10/1995","5809296","Camila Aguirre","3931851");


        //Psiquiatra.
        Psiquiatra Psiquiatra1 = new Psiquiatra("1017252071","Andrés Felipe","García Revuelta","Andres@gmail.com","M","Cl. 80 #54-20",23,"07/01/1993",8790344);
        Psiquiatra Psiquiatra2 = new Psiquiatra("1036688091","Innis Dapney","Salazar García","Innis@gmail.com","F","Cra. 46 #35-14",22,"12/10/1998",4410349);
        Psiquiatra Psiquiatra3 = new Psiquiatra("1152472574","Valentina ","Sabogal Serrano","Valentina@gmail.com","F","Cl. 69 #86-55",23,"25/07/1993",44208674);
