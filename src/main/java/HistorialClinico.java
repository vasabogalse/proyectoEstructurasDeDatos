...
public class HistorialClinico implements handleJSON {
                ...
                for (String pacienteP : psiquiatra.getListaPacientes()) {
                    if (pacienteP.equals(cedulaPaci) ) {
                        ...
                        if (pacienteH.getHistorialClinico() == 0) {
                            ...
                            pacienteH.setHistorialClinico(historialClinico.idHistClinico);
                            psiquiatra.getHistoriales().add(historialClinico.idHistClinico);
                            db.appendArrayToJSON("pacientes");
                            db.appendArrayToJSON("psiquiatras");
                            historialClinico.setPaciente(pacienteH.getIdPaciente());
                            historialClinico.setPsiquiatra(psiquiatra.getIdPsiquiatra());
    ...
    public  void editarHistClinico(Psiquiatra psiquiatra) {
        ...
        for (Paciente pacienteSis : db.getPacientes()){
            if(pacienteSis.getIdPaciente().equals(cedulaPaci) ){
                for (String paciente : psiquiatra.getListaPacientes()){
                    if (paciente.equals(cedulaPaci)) {
                        for (HistorialClinico historialClinico: db.getHistoriales()){
                            if (historialClinico.getPaciente().equals(cedulaPaci) ){
                                String option;
                                label:
                                while (true) {
                                    System.out.println();
    ...
    public  void verHistClinico(Psiquiatra psiquiatra) {
        ...
        for (Paciente pacienteSis : db.getPacientes()){
            if(pacienteSis.equals(cedulaPaci) ){
                for (String paciente : psiquiatra.getListaPacientes()){
                    if (paciente.equals(cedulaPaci)) {
                        for (HistorialClinico historialClinico : db.getHistoriales()){
                            if (historialClinico.getPaciente().equals(cedulaPaci)){
